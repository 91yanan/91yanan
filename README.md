...
### Product Director · [BeNovel](https://benovel.site/)
...
Contributing to AI development in an enterprise software environment. Project details are limited to respect confidentiality.
...
An AI system for analyzing customer-service satisfaction using multimodal data. My work includes real-time facial emotion recognition, seat-presence detection, multi-camera processing, and emotion visualization using Python, OpenCV, DeepFace, and Keras.

### Hakka AI & System Development

Led the development of an AI application that won **1st Place at the Hakka AI Hackathon**. I was later invited to share AI application and project-development experience as a guest lecturer.
...
- **National Taiwan University** — M.S. in Information Management, 2025–Present
- **National Central University** — B.M. in Information Management
  - Phi Tau Phi Honor Society
  - Outstanding Student Award
  - Three-time Academic Achievement Award
